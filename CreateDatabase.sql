...
CREATE DATABASE [Proyecto1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Proyecto1', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\Proyecto1.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Proyecto1_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\Proyecto1_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Proyecto1] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [Proyecto1] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
